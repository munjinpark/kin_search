KEYWORD_MAP = {
    ...
    '청약': ['청약', '청년 주택드림', '청년주택', '청년내집마련', '청년자산형성', '특별공급'],
    '병원비': ['병원비', '진료비', '비급여', '도수치료', '검진', '의료비', '수술비', '입원비', '검진', 'MRI', 'CT', '도수'],
    '실손보험': ['실손', '실비', '내보험찾아줌', '보험'],
    ...
    '온누리상품권': ['온누리상품권', '전통시장', '지역화폐', '지역사랑상품권', '비플페이'],
    '드라마' : ['드라마', '넷플릭스', '티빙', '웨이브', '디즈니플러스', '정주행', '미드', '일드', 'ott'],
